...
The exploratory data analysis is conducted in the [exploratory_data_analysis.ipynb](exploratory_data_analysis.ipynb) notebook, exploratory_data_analysis_Team1.ipynb which includes:
